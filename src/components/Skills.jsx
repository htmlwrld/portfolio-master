...
const Skills = () => {
  return (
    <section className="bg-black max-w-[1400px] mx-auto" id="skills">
      ...
      <div className="h-[100%] mx-auto xl:max-w-[1250px] bg-black relative">
        ...
        <div class="absolute grid overflow-hidden grid-cols-12 grid-rows-6 gap-0 top-0 right-0 bottom-0 left-0">
          ...
          <div class="box"></div>
          <div class="box"></div>
          <div class="javascript box col-span-2 relative">
            <div className="tooltip hvr-bob tooltip-js absolute w-[100%] md:top-10 top-5 left-[49%]">
              ...
              <span class="tooltiptext">JavaScript: 50%</span>
            </div>
          </div>
          <div class="box"></div>
          <div class="figma relative box">
            <div className="tooltip hvr-bob tooltip-figma absolute max-w-full h-auto bottom-3 md:bottom-5">
              ...
              <span class="tooltiptext">Figma: Beginner</span>
            </div>
          </div>
          <div class="box col-span-2"></div>
          <div class="box row-span-2"></div>
          <div class="box row-span-2"></div>
          <div class="vscode box row-span-2 relative">
            <div className="hvr-bob tooltip tooltip-vsc absolute w-[100%] top-[40%] left-0">
              ...
              <span class="tooltiptext">VSC: Advanced</span>
            </div>
          </div>
          <div class=" box "></div>
          <div class="html box row-span-2 col-span-2 relative">
            <div className="tooltip hvr-bob  html absolute w-[70%] right-1 top-2">
              ...
              <span class="tooltiptext">HTML: 85%</span>
            </div>
          </div>
          <div class="css box row-span-2 col-span-2 relative">
            <div className="tooltip hvr-bob  tooltip-css absolute w-[100%] bottom-0 left-1">
              ...
              <span class="tooltiptext">CSS: 65%</span>
            </div>
          </div>
          <div class="vite box row-span-2 relative">
            <div className="hvr-bob tooltip tooltip-vite absolute w-[70%] h-auto left-3 top-10 md:top-[30%] md:left-10">
              ...
              <span class="tooltiptext">Vite: Advanced</span>
            </div>
          </div>
          <div class="box row-span-2"></div>
          <div class="tailwind box row-span-2 relative">
            <div className="hvr-bob tooltip tooltip-tail absolute w-[75%] top-[20%] right-[-0.7rem]">
              ...
              <span class="tooltiptext">Tailwind: 90%</span>
            </div>
          </div>
          <div class="box row-span-2"></div>
          <div class="react box row-span-2 relative">
            <div className="hvr-bob tooltip tooltip-react absolute w-[100%] top-[30%]">
              ...
              <span class="tooltiptext">React: 30%</span>
            </div>
          </div>
          <div class="box row-span-2"></div>
          <div class="box row-span-2"></div>
